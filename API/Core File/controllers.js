...
.controller('PostNEWTicketCtrl', function($scope,$state ,$ionicPopup ,PostTicket) {
 ...
 $scope.submitTicket = function() {
         ...
         if ($scope.data.subject && $scope.data.technician && $scope.data.body) {
...
$scope.updateTicket = function() {
  ...
  if ($scope.details.TIC_Subject && $scope.details.TIC_Tech && $scope.details.TIC_Body && $scope.details.TIC_ID) {
